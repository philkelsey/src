...
/*	private void populateTree(){
	...
	*/
	public enum FileDelimiter {	comma, tab	}
/*
...
*/
	...
	{
		System.out.println("Inside GIS DataSet constructor ");
		fileType = "GIS";
	...
	public void sortData() 	{ Collections.sort(data); }
	...
	private void importDataSet()
	{
		try
		{
			...
			while((line = br.readLine()) != null) { parseDataLine(line); }
			dataCount = data.size();
			fr.close();
		//	populateTree();
		}
		catch(FileNotFoundException e) { System.out.println("File Not Found: " + dataSetFileName); }
	...
	private void parseHeaderLine(String headerLine)
	{
		...
		for(int i = 0; i < s.length; i++) 	{ header.add(i, s[i]);	}
	}//end parseHeaderLine
	...
	public ArrayList<String[]> getOtherData()	{	return otherData;	}
